# Lecture 06 – Database Schema & Models (Mongoose)
...
**MongoDB Compass** – GUI tool to visualize databases, collections, and documents

---

## MongoDB Compass – Account & Cluster Setup (Hinglish Steps)
...
- “Build a Database” par click karo
...
- Cluster ke “Connect” button par click karo
...
- “New Connection” par click karo
- Connection string paste karo
- Connect button dabao

👉 Ab aap apna database visually dekh sakte ho
...
👉 Ye fields milkar **User Schema** banate hain
...
👉 **Uske baad server listen karega**
